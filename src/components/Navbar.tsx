        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="absolute top-20 left-0 right-0 bg-brand-black/95 backdrop-blur-lg border border-white/10 shadow-2xl rounded-3xl p-8 flex flex-col items-center gap-6 md:hidden z-40"
            >
